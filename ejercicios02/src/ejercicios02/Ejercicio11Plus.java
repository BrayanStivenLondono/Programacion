...
public class Ejercicio11Plus {
	...
	public static void main(String[] args) {
		...
		boolean comienzaVocal = cadena.charAt(0)=='a' || cadena.charAt(0)=='e' || cadena.charAt(0)=='i' ||cadena.charAt(0)=='o' || cadena.charAt(0)=='u';
		...
		boolean terminaVocal=cadena.charAt(posicionFinal)=='a' || cadena.charAt(posicionFinal)=='e' || cadena.charAt(posicionFinal)=='i'
				|| cadena.charAt(posicionFinal)=='o' || cadena.charAt(posicionFinal)=='u';
